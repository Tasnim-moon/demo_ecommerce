...
<div class="span9">
	...
	<h3>  SHOPPING CART [ <small>0 Item(s) </small>]<a href="products.html" class="btn btn-large pull-right"><i class="icon-arrow-left"></i> Continue Shopping </a></h3>	
	<hr class="soft"/>		
      ...
      <tbody>
        ...
        <tr>
          ...
          <td> ${{$sum}}</td>
            ...
            <td>Pay with card<input type="checkbox" name="card" style="margin-left: 12px;"></td>
